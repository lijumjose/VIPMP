...
- When a Partner (or support) initiates the creation of a linked membership with a specified customer as the owner through the [Update Customer API](../../../docs/customer-account/update-customer-account.md).
