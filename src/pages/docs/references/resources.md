...
|Source| String | Indicates the origin of the order. Possible values are: <br /> - **API:** Order placed through APIs <br /> - **System:** Order generated by the system.| 4 characters|
