...
|Source| String | Indicates the origin of the order and return. Possible values are: <br /> - **API:** Order placed through APIs <br /> - **System:** Order generated by the system.<br /> - **Bridge:** Order created through The Bridge UI| 4 characters|
