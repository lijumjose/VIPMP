...
- If the Correlation ID header is not included, a 400 error with status code _4119 – Correlation ID is Invalid or Missing_ will be returned. Read more about [Status Codes](status-codes.md).
