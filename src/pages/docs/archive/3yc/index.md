...
Using the Preview Order API to determine the appropriate discount level is crucial. The [Preview Order](../../migration/preview-offers.md) API considers the customer's 3YC commitment and any accepted commitment requests to provide the Offer ID with the best discount.
